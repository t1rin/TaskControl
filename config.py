...
[h3]local commands:[/h3]
  ...
  [cmd]info[/cmd] [h2]\[\[1 номер] \[2 номер] ... \[n номер]][/h2] если номера не указаны, возвращает общие сведения о выполненных заданиях, иначе о номерах
